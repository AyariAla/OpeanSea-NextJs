...
const Collection = () => {
  ...
  useEffect(() => {
    ...
    async () => {
      ...
      console.log(nfts, 'Listings NFTS in collection');
      setNftList(nfts);
    };
  }, [nftModule]);
  ...
  const fetchCollectionData = async (
    ...
    // Query will return 1 pbject inside and array
        ...
        <div className={style.midRow}>
          <div className={style.statsContainer}>
            <div className={style.collectionStat}>
              <div className={style.statValue}>{nftList.length}</div>
